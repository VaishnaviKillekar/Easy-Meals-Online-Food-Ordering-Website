<!--
	...
	Date: November 2017
	Description: Adds new dish details to database.
-->
	   ...
	   <div class="container">
		  <div class="register">
		  	<?php
				...
				$test_res=mysqli_query($con, "SELECT R_MenuId FROM restaurant WHERE R_Id='$_SESSION[rid]'");
				$test_row=mysqli_fetch_array($test_res);
				
				$res=mysqli_query($con, "INSERT INTO menu_card (R_Id, Menu_Id, Dish_Name, Dish_Type, Dish_Price) VALUES ('$_SESSION[rid]', '$test_row[R_MenuId]', '$_POST[dname]', '$_POST[dtype]','$_POST[dprice]')");
