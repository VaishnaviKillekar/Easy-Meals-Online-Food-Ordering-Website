<!--
	...
	Date: November 2017
	Description: PHP file to add the customer's order to the database.
-->
	   ...
	   <div class="container">
		  <div class="register">
		  	<?php
				...
				$res=mysqli_query($con, "INSERT INTO orders (R_Id, Dishes_Ordered, Order_Time, Order_Bill, Order_CustId, Order_Status) VALUES ('$_SESSION[RestId]', '$dishes', '$date', '$_SESSION[total]', '$_SESSION[UserID]', 'PENDING')");
