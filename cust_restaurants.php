<!--
	...
	Date: November 2017
	Description: Custommer can view all registered restaurants where they can order from.
-->
...
<html>
<head>
<title>EasyMeals-Restaurants</title>
			...
			<div class="container">
				<!--div class="Popular-Restaurants-grid wow fadeInRight" data-wow-delay="0.4s">
					<div class="col-md-3 restaurent-logo">
						<img src="images/res7.jpg" class="img-responsive" alt="Saffron"/>
					</div>
					<div class="col-md-2 restaurent-title">
						<div class="logo-title">
							<h4><a href="#">Saffron</a></h4>
						</div>
						<div class="rating">
							<span>Ratings</span>
					...
					<a class="morebtn hvr-rectangle-in" href="cust_orders-list.php">View Menu</a>
					</div>
					<div class="clearfix"></div>
				</div>
				...
				<div class="Popular-Restaurants-grid wow fadeInLeft" data-wow-delay="0.4s">
					<div class="col-md-3 restaurent-logo">
						<img src="images/res2.jpg" class="img-responsive" alt="Food paradise" />
					</div>
					<div class="col-md-2 restaurent-title">
						<div class="logo-title logo-title-1">
							<h4><a href="#">Food Paradise</a></h4>
						</div>
						<div class="rating">
							<span>Ratings</span>
				...
				<div class="Popular-Restaurants-grid wow fadeInRight" data-wow-delay="0.4s">
					<div class="col-md-3 restaurent-logo">
						<img src="images/res6.jpg" class="img-responsive" alt="Pick N Pack" />
					</div>
					<div class="col-md-2 restaurent-title">
						<div class="logo-title logo-title-2">
							<h4><a href="#">Pick N Pack</a></h4>
						</div>
						<div class="rating">
							<span>Ratings</span>
							<a href="#"> <img src="images/star1.png" class="img-responsive" alt="">(004)</a>
				...
				<div class="Popular-Restaurants-grid wow fadeInLeft" data-wow-delay="0.4s">
					<div class="col-md-3 restaurent-logo">
						<img src="images/res4.jpg" class="img-responsive" alt="Food Circle" />
					</div>
					<div class="col-md-2 restaurent-title">
						<div class="logo-title logo-title-3">
							<h4><a href="#">Food Circle</a></h4>
						</div>
						<div class="rating">
							<span>Ratings</span>
							<a href="#"> <img src="images/star2.png" class="img-responsive" alt="">(005)</a>
				...
				<div class="Popular-Restaurants-grid wow fadeInRight" data-wow-delay="0.4s">
					<div class="col-md-3 restaurent-logo">
						<img src="images/res5.jpg" class="img-responsive" alt="Tasty Treat" />
					</div>
					<div class="col-md-2 restaurent-title">
						<div class="logo-title logo-title-4">
							<h4><a href="#">Tasty Treat</a></h4>
						</div>
						<div class="rating">
							<span>Ratings</span>
							<a href="#"> <img src="images/star1.png" class="img-responsive" alt="">(004)</a>
				...
				<?php
					...
					//reviews_ratings WHERE restaurant.R_Id=reviews_ratings.R_Id");
					while($row=mysqli_fetch_array($res))
					{
						echo "<div class='Popular-Restaurants-grid wow fadeInRight' data-wow-delay='0.4s'>
								<div class='col-md-3 restaurent-logo'>
								<img src='$row[R_Img]' class='img-responsive' alt='Saffron'/>
								</div>
								<div class='col-md-2 restaurent-title'>
									<div class='logo-title'>
										<h4><a href='#'>$row[R_Name]</a></h4>
									</div>
									<div><h5>$row[R_Address]</h5></div>
								</div>
								<div class='col-md-7 buy'>
									<a class='morebtn hvr-rectangle-in' href='cust_orders-list.php?rid=$row[R_Id]'>View Menu</a>
								</div>
								<div class='clearfix'></div>
								</div>";
					}
