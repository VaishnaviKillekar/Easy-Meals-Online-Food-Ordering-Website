<!--
	...
	Date: November 2017
	Description: PHP file which reflects Manager's changes to the dishes in the menu in the database.
-->
	   ...
	   <div class="container">
		  <div class="register">
		  	<?php
				...
				$res=mysqli_query($con, "UPDATE menu_card SET Dish_Name='$_POST[dname]', Dish_Type='$_POST[dtype]', Dish_Price='$_POST[dprice]', Dish_Available='$_POST[avail]' WHERE Dish_Id='$_GET[did]'");
