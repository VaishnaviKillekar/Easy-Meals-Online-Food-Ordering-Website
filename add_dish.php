<!--
	...
	Date: November 2017
	Description: Form to add a new dish to the menu for Restaurant Owner.
-->
...
<html>
<head>
<title>EasyMeals-Add Dishes</title>
		  	...
		  	<form action="add_dish_submit.php" method="POST"> 
				 <div class="register-top-grid">
					...
					<h3>Add dishes</h3>
					 ...
					 <div class="wow fadeInLeft" data-wow-delay="0.4s">
						<span>Dish Type <c style="color:red;">*</c></span>
						<input type="text" name="dtype" pattern="[A-Za-z]+[_]*[A-Za-z]+" required /> 
					 </div>
					 <div class="wow fadeInLeft" data-wow-delay="0.4s">
