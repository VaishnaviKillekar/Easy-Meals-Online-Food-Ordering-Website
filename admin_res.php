<!--
	...
	Date: November 2017
	Description: Admin can view all restaurant details.
-->
...
<html>
<head>
<title>EasyMeals-Restaurant</title>
...
<div class="content">
	<div class="main">
	   <div class="container">
		  <div class="register">			
		  	<center>
				<a href="manage_restaurants.php"><input type="button" value="Delete Restaurants"/></a>&emsp;
				<a href="add_res.php"><input type="button" value="Add Restaurants"/></a>
			</center>			<br>
		  	<?php
				include_once('db.php');
